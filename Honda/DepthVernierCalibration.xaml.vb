...
Public Class DepthVernierCalibration
    ...
    Private _activeMaxRange As Decimal = 300

    Private ReadOnly nominalRanges As Decimal() = {0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300}
    ...
    Private Sub AdjustVisibilityBySize(sizeStr As String)
        Try
            _activeMinRange = 0 : _activeMaxRange = 300
    ...
    Private Sub ObservationKeyDown(sender As Object, e As KeyEventArgs)
        If e.Key = Key.Enter Then
            ...
            If nameParts.Length = 2 Then
                ...
                Else
                    ' Trial 3 finished, enable next range
    ...
    Private Sub LoadDynamicLC()
        Try
            Dim dt = MySqlCls.ReadDatatable("SELECT DISTINCT LC FROM depth_vernier_calibration WHERE RowType='MASTER' ORDER BY LC ASC")
    ...
    Private Sub ComboBox5_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles ComboBox5.SelectionChanged
        If ComboBox5.SelectedItem IsNot Nothing Then
            ...
            _masterLimits = MySqlCls.GetDepthVernierMasterLimits(selectedLC)
    ...
    Private Sub Button2_Click(sender As Object, e As RoutedEventArgs) Handles Button2.Click
        ...
        Dim obs0 = GetTrialsArrayFromUI(0), obs25 = GetTrialsArrayFromUI(25), obs50 = GetTrialsArrayFromUI(50)
        Dim obs75 = GetTrialsArrayFromUI(75), obs100 = GetTrialsArrayFromUI(100), obs125 = GetTrialsArrayFromUI(125)
        Dim obs150 = GetTrialsArrayFromUI(150), obs175 = GetTrialsArrayFromUI(175), obs200 = GetTrialsArrayFromUI(200)
        Dim obs225 = GetTrialsArrayFromUI(225), obs250 = GetTrialsArrayFromUI(250), obs275 = GetTrialsArrayFromUI(275), obs300 = GetTrialsArrayFromUI(300)

        Dim saved As Boolean = False
        If IsEditMode Then
            saved = MySqlCls.UpdateDepthVernierCalibration(
                ...
                obs0, obs25, obs50, obs75, obs100, obs125, obs150, obs175, obs200, obs225, obs250, obs275, obs300,
                ...
                calibDateToSave)
        Else
            saved = MySqlCls.InsertDepthVernierCalibration(
    ...
    Private Sub PopulateCalibrationData()
        ...
        Dim dt = MySqlCls.GetDepthVernierCalibrationData(TextBox1.Text.Trim(), TargetCycle)
