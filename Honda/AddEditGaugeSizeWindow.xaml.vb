...
Public Class AddEditGaugeSizeWindow
    ...
    Private Sub LoadTypes()
        Try
            Dim dt = _mySql.GetGaugeTypesOnly()
    ...
    Private Sub BtnSave_Click(sender As Object, e As RoutedEventArgs)
        ...
        If _isEditMode Then
            success = _mySql.UpdateGaugeSize(_currentId, type, size, groupCode, active, sort)
        Else
            success = _mySql.InsertGaugeSize(type, size, groupCode, active, sort)
        End If
