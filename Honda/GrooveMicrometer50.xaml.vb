...
Public Class GrooveMicrometer50
    ...
    Private ReadOnly nominalRangesExt As Decimal() = {25, 30, 35, 40, 45, 50}
    Private ReadOnly nominalRangesInt As Decimal() = {25, 30, 35, 40, 45, 50}
    ...
    Private Sub PopulateCalibrationData()
        Try
            Dim dt = MySqlCls.GetGrooveMicrometer50Data(TextBox1.Text.Trim(), TargetCycle)
    ...
    Private Sub AdjustVisibilityBySize(sizeStr As String)
        Try
            ...
            If ComboBox5.SelectedItem IsNot Nothing Then
                ...
                If firstInRange >= 25 Then EnableRange(firstInRange, True)
            End If
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub TrialTextChanged(sender As Object, e As TextChangedEventArgs)
        ...
        Try
            ...
            If Decimal.TryParse(txtBox.Text, val) Then
                ' DUAL MODE: User might type raw reading (25.001) OR error offset (0.001)
    ...
    Private Sub LoadDynamicLC()
        Try
            Dim dt = MySqlCls.ReadDatatable("SELECT DISTINCT LC FROM groove_micrometer_50 WHERE RowType='MASTER' ORDER BY LC ASC")
    ...
    Private Sub ComboBox5_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles ComboBox5.SelectionChanged
        If ComboBox5.SelectedItem IsNot Nothing Then
            ...
            _masterLimits = MySqlCls.GetGrooveMicrometer50MasterLimits(selectedLC)
            ResetAllTrials()
            AdjustVisibilityBySize(TextBox21.Text)
            EnableRange(25, True)
        Else
    ...
    Private Sub Button2_Click(sender As Object, e As RoutedEventArgs) Handles Button2.Click
        ...
        ' Prepare arrays
        Dim ext25 = GetTrialsArrayFromUI(25, True), ext30 = GetTrialsArrayFromUI(30, True), ext35 = GetTrialsArrayFromUI(35, True)
        Dim ext40 = GetTrialsArrayFromUI(40, True), ext45 = GetTrialsArrayFromUI(45, True), ext50 = GetTrialsArrayFromUI(50, True)
        Dim int25 = GetTrialsArrayFromUI(25, False), int30 = GetTrialsArrayFromUI(30, False), int35 = GetTrialsArrayFromUI(35, False)
        Dim int40 = GetTrialsArrayFromUI(40, False), int45 = GetTrialsArrayFromUI(45, False), int50 = GetTrialsArrayFromUI(50, False)

        Dim saved As Boolean = False
        If IsEditMode Then
            saved = MySqlCls.UpdateGrooveMicrometer50(
                ...
                ext25, ext30, ext35, ext40, ext45, ext50,
                int25, int30, int35, int40, int45, int50,
                ...
                calibDateToSave)
        Else
            saved = MySqlCls.InsertGrooveMicrometer50(
