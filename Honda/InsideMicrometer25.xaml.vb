...
Public Class InsideMicrometer25
    ...
    Private ReadOnly nominalRanges As Decimal() = {5.1, 7.7, 10.3, 12.9, 15.0, 17.6, 20.2, 22.8, 25.0, 27.5, 30.0}
    ...
    Private Sub PopulateCalibrationData()
        Try
            Dim dt = MySqlCls.GetInsideMicrometer25Data(TextBox1.Text.Trim(), TargetCycle)
            If dt.Rows.Count > 0 Then
                ...
                SetTrialsFromDB(row, "Obs30_0_", GetTextBoxesForRange(30.0))
    ...
    Private Sub AdjustVisibilityBySize(sizeStr As String)
        Try
            _activeMinRange = 5 : _activeMaxRange = 30
    ...
    Private Sub LoadInstrumentDetails(controlNo As String)
        Try
            ...
            Next
            If Not found Then
                _instrumentName = "" : ComboBox2.Text = "" : TextBoxColor.Text = "" : TextBox21.Text = "5-30 mm" : UpdateSizeLockState()
            End If
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub LoadDynamicLC()
        Try
            Dim dt = MySqlCls.ReadDatatable("SELECT DISTINCT LC FROM inside_micrometer_25 WHERE RowType='MASTER' ORDER BY LC ASC")
    ...
    Private Sub ComboBox5_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles ComboBox5.SelectionChanged
        If ComboBox5.SelectedItem IsNot Nothing Then
            ...
            _masterLimits = MySqlCls.GetInsideMicrometer25MasterLimits(selectedLC)
            ResetAllTrials()
            AdjustVisibilityBySize(TextBox21.Text)
            EnableRange(5)
        Else
    ...
    Private Sub Button2_Click(sender As Object, e As RoutedEventArgs) Handles Button2.Click
        ...
        Dim obs5_1 = GetTrialsArrayFromUI(nominalRanges(0))
        Dim obs7_7 = GetTrialsArrayFromUI(nominalRanges(1))
        Dim obs10_3 = GetTrialsArrayFromUI(nominalRanges(2))
        Dim obs12_9 = GetTrialsArrayFromUI(nominalRanges(3))
        Dim obs15_0 = GetTrialsArrayFromUI(nominalRanges(4))
        Dim obs17_6 = GetTrialsArrayFromUI(nominalRanges(5))
        Dim obs20_2 = GetTrialsArrayFromUI(nominalRanges(6))
        Dim obs22_8 = GetTrialsArrayFromUI(nominalRanges(7))
        Dim obs25_0 = GetTrialsArrayFromUI(nominalRanges(8))
        Dim obs27_5 = GetTrialsArrayFromUI(nominalRanges(9))
        Dim obs30_0 = GetTrialsArrayFromUI(nominalRanges(10))
        ...
        If IsEditMode Then
            saved = MySqlCls.UpdateInsideMicrometer25(
                ...
                obs5_1, obs7_7, obs10_3, obs12_9, obs15_0, obs17_6, obs20_2, obs22_8, obs25_0, obs27_5, obs30_0,
                ...
                calibDateToSave)
        Else
            saved = MySqlCls.InsertInsideMicrometer25(
                _instrumentName, TextBox1.Text.Trim(), cycleName, TextBox21.Text, lcVal, TextBoxColor.Text, ComboBox2.Text, TextBox30.Text, TextBox28.Text, TextBox29.Text,
                obs5_1, obs7_7, obs10_3, obs12_9, obs15_0, obs17_6, obs20_2, obs22_8, obs25_0, obs27_5, obs30_0,
                If(String.IsNullOrEmpty(TextBox20.Text), "-", TextBox20.Text), TextBox24.Text, TextBox26.Text, TextBox25.Text, statusVal, TextBox19.Text,
                calibDateToSave)
