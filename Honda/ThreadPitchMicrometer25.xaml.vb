...
Public Class ThreadPitchMicrometer25
    ...
    Private ReadOnly nominalRanges As Decimal() = {2.5, 5.1, 7.7, 10.3, 12.9, 15.0, 17.6, 20.2, 22.8, 25.0}
    ...
    Private Sub PopulateCalibrationData()
        Try
            Dim dt = MySqlCls.GetThreadPitchMicrometer25Data(TextBox1.Text.Trim(), TargetCycle)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                Dim obsCols = {"Obs2_5", "Obs5_1", "Obs7_7", "Obs10_3", "Obs12_9", "Obs15_0", "Obs17_6", "Obs20_2", "Obs22_8", "Obs25_0"}
    ...
    Private Sub LoadInstrumentDetails(controlNo As String)
        Try
            ...
            Next
            If Not found Then
                _instrumentName = "" : ComboBox2.Text = "" : TextBoxColor.Text = "" : TextBox21.Text = "0-25 mm" : TextBox21.SelectedIndex = -1
            End If
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub LoadDynamicLC()
        Try
            Dim dt = MySqlCls.ReadDatatable("SELECT DISTINCT LC FROM thread_pitch_micrometer_25 WHERE RowType='MASTER' ORDER BY LC ASC")
    ...
    Private Sub ComboBox5_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles ComboBox5.SelectionChanged
        If ComboBox5.SelectedItem IsNot Nothing Then
            ...
            _masterLimits = MySqlCls.GetThreadPitchMicrometer25MasterLimits(selectedLC)
    ...
    Private Sub Button2_Click(sender As Object, e As RoutedEventArgs) Handles Button2.Click
        ...
        Dim obs2_5 = GetTrialsArrayFromUI(nominalRanges(0))
        Dim obs5_1 = GetTrialsArrayFromUI(nominalRanges(1))
        Dim obs7_7 = GetTrialsArrayFromUI(nominalRanges(2))
        Dim obs10_3 = GetTrialsArrayFromUI(nominalRanges(3))
        Dim obs12_9 = GetTrialsArrayFromUI(nominalRanges(4))
        Dim obs15_0 = GetTrialsArrayFromUI(nominalRanges(5))
        Dim obs17_6 = GetTrialsArrayFromUI(nominalRanges(6))
        Dim obs20_2 = GetTrialsArrayFromUI(nominalRanges(7))
        Dim obs22_8 = GetTrialsArrayFromUI(nominalRanges(8))
        Dim obs25_0 = GetTrialsArrayFromUI(nominalRanges(9))

        Dim saved As Boolean
        If IsEditMode Then
            saved = MySqlCls.UpdateThreadPitchMicrometer25(
                ...
                obs2_5, obs5_1, obs7_7, obs10_3, obs12_9, obs15_0, obs17_6, obs20_2, obs22_8, obs25_0,
                ...
                calibDateToSave)
        Else
            saved = MySqlCls.InsertThreadPitchMicrometer25(
