...
Public Class ThreadPitchMicrometer70
    ...
    Private _activeMinRange As Decimal = 50
    Private _activeMaxRange As Decimal = 75

    Private ReadOnly nominalRanges As Decimal() = {52.5, 55.1, 57.7, 60.3, 62.9, 65.0, 67.6, 70.2, 72.8, 75.0}
    ...
    Private Sub PopulateCalibrationData()
        Try
            Dim dt = MySqlCls.GetThreadPitchMicrometer75Data(TextBox1.Text.Trim(), TargetCycle)
            If dt IsNot Nothing AndAlso dt.Rows.Count > 0 Then
                ...
                Dim obsCols = {"Obs52_5", "Obs55_1", "Obs57_7", "Obs60_3", "Obs62_9", "Obs65_0", "Obs67_6", "Obs70_2", "Obs72_8", "Obs75_0"}
    ...
    Private Sub AdjustVisibilityBySize(sizeStr As String)
        Try
            _activeMinRange = 50 : _activeMaxRange = 75
    ...
    Private Sub LoadInstrumentDetails(controlNo As String)
        Try
            ...
            Next
            If Not found Then
                _instrumentName = "" : ComboBox2.Text = "" : TextBoxColor.Text = "" : TextBox21.Text = "50-75 mm" : TextBox21.SelectedIndex = -1
            End If
        Catch ex As Exception
        End Try
    End Sub
    ...
    Private Sub LoadDynamicLC()
        Try
            Dim dt = MySqlCls.ReadDatatable("SELECT DISTINCT LC FROM thread_pitch_micrometer_75 WHERE RowType='MASTER' ORDER BY LC ASC")
    ...
    Private Sub ComboBox5_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles ComboBox5.SelectionChanged
        If ComboBox5.SelectedItem IsNot Nothing Then
            ...
            _masterLimits = MySqlCls.GetThreadPitchMicrometer75MasterLimits(selectedLC)
    ...
    Private Sub Button2_Click(sender As Object, e As RoutedEventArgs) Handles Button2.Click
        ...
        Dim obs52_5 = GetTrialsArrayFromUI(nominalRanges(0))
        Dim obs55_1 = GetTrialsArrayFromUI(nominalRanges(1))
        Dim obs57_7 = GetTrialsArrayFromUI(nominalRanges(2))
        Dim obs60_3 = GetTrialsArrayFromUI(nominalRanges(3))
        Dim obs62_9 = GetTrialsArrayFromUI(nominalRanges(4))
        Dim obs65_0 = GetTrialsArrayFromUI(nominalRanges(5))
        Dim obs67_6 = GetTrialsArrayFromUI(nominalRanges(6))
        Dim obs70_2 = GetTrialsArrayFromUI(nominalRanges(7))
        Dim obs72_8 = GetTrialsArrayFromUI(nominalRanges(8))
        Dim obs75_0 = GetTrialsArrayFromUI(nominalRanges(9))

        Dim saved As Boolean
        If IsEditMode Then
            saved = MySqlCls.UpdateThreadPitchMicrometer75(
                ...
                obs52_5, obs55_1, obs57_7, obs60_3, obs62_9, obs65_0, obs67_6, obs70_2, obs72_8, obs75_0,
                ...
                calibDateToSave)
        Else
            saved = MySqlCls.InsertThreadPitchMicrometer75(
