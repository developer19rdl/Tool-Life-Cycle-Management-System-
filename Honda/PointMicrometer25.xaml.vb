...
Public Class PointMicrometer25
    ...
    Private Sub Window_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ComboBox1.Text = "Point Micrometer"
        LoadDynamicLC()
    ...
    Private Sub PopulateCalibrationData()
        Try
            Dim dt = MySqlCls.GetPointMicrometer25Data(TextBox1.Text.Trim(), TargetCycle)
            If dt.Rows.Count > 0 Then
                ...
                SetTrialsFromDB(row, "Obs2_5_", GetTextBoxesForRange(2.5))
                SetTrialsFromDB(row, "Obs5_1_", GetTextBoxesForRange(5.1))
                SetTrialsFromDB(row, "Obs7_7_", GetTextBoxesForRange(7.7))
                SetTrialsFromDB(row, "Obs10_3_", GetTextBoxesForRange(10.3))
                SetTrialsFromDB(row, "Obs12_9_", GetTextBoxesForRange(12.9))
                SetTrialsFromDB(row, "Obs15_0_", GetTextBoxesForRange(15.0))
                SetTrialsFromDB(row, "Obs17_6_", GetTextBoxesForRange(17.6))
                SetTrialsFromDB(row, "Obs20_2_", GetTextBoxesForRange(20.2))
                SetTrialsFromDB(row, "Obs22_8_", GetTextBoxesForRange(22.8))
                SetTrialsFromDB(row, "Obs25_0_", GetTextBoxesForRange(25.0))
    ...
    Private Sub TrialTextChanged(sender As Object, e As TextChangedEventArgs)
        ...
        Try
            ...
            If Decimal.TryParse(txtBox.Text, val) Then
                ' For Point Micrometer, use the raw value as the error comparison
    ...
    Private Function TryMatchSize(inputSize As String, availableSizes As List(Of String)) As String
        ...
        ' Try range matching (e.g., "0-25" matches "0-25 mm")
    ...
    Private Sub LoadDynamicLC()
        Try
            Dim dt = MySqlCls.ReadDatatable("SELECT DISTINCT LC FROM point_micrometer_25 WHERE RowType='MASTER' ORDER BY LC ASC")
    ...
    Private Sub ComboBox5_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles ComboBox5.SelectionChanged
        If ComboBox5.SelectedItem IsNot Nothing Then
            ...
            _masterLimits = MySqlCls.GetPointMicrometer25MasterLimits(selectedLC)
            ResetAllTrials()
            AdjustVisibilityBySize(TextBox21.Text)
            EnableRange(nominalRanges(0))
        Else
    ...
    Private Sub Button2_Click(sender As Object, e As RoutedEventArgs) Handles Button2.Click
        ...
        If IsEditMode Then
            saved = MySqlCls.UpdatePointMicrometer25(
                ...
                calibDateToSave)
        Else
            saved = MySqlCls.InsertPointMicrometer25(
                _instrumentName, TextBox1.Text.Trim(), cycleName, TextBox21.Text, ComboBox5.Text, TextBoxColor.Text, ComboBox2.Text, TextBox30.Text, TextBox28.Text, TextBox29.Text,
                obs2_5, obs5_1, obs7_7, obs10_3, obs12_9, obs15_0, obs17_6, obs20_2, obs22_8, obs25_0,
                If(String.IsNullOrEmpty(TextBox20.Text), "-", TextBox20.Text), TextBox24.Text, TextBox26.Text, TextBox25.Text, statusVal, TextBox19.Text,
                calibDateToSave)
        ...
        For i = 0 To 2
            If i < tbs.Count Then
                ...
                If Decimal.TryParse(tbs(i).Text, val) Then
                    ' For Point Micrometer, save the raw value as the error
                    Dim errorVal As Decimal = val
